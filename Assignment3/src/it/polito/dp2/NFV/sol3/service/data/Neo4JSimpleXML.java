...
package it.polito.dp2.NFV.sol3.service.data;
...
}, comments = "wadl2java, http://wadl.java.net", date = "2018-01-20T02:51:15.770+01:00")
public class Neo4JSimpleXML {
    ...
    static {
        ...
        java.io.InputStream is = Neo4JSimpleXML.class.getResourceAsStream("/META-INF/jax-rs-catalog.xml");
        if (is!=null) {
            try {
    ...
    public static Neo4JSimpleXML.Resource resource(Client client, URI baseURI) {
        return new Neo4JSimpleXML.Resource(client, baseURI);
    }
    ...
    public static Neo4JSimpleXML.Resource resource() {
        return resource(createClient(), BASE_URI);
    }

    public static Neo4JSimpleXML.Resource resource(Client client) {
        return resource(client, BASE_URI);
    }

    public static Neo4JSimpleXML.Seed seed(Client client, URI baseURI) {
        return new Neo4JSimpleXML.Seed(client, baseURI);
    }

    public static Neo4JSimpleXML.Seed seed() {
        return seed(createClient(), BASE_URI);
    }

    public static Neo4JSimpleXML.Seed seed(Client client) {
        return seed(client, BASE_URI);
    }

    public static Neo4JSimpleXML.Data data(Client client, URI baseURI) {
        return new Neo4JSimpleXML.Data(client, baseURI);
    }

    public static Neo4JSimpleXML.Data data() {
        return data(createClient(), BASE_URI);
    }

    public static Neo4JSimpleXML.Data data(Client client) {
        return data(client, BASE_URI);
    }

    public static Neo4JSimpleXML.Root root(Client client, URI baseURI) {
        return new Neo4JSimpleXML.Root(client, baseURI);
    }

    public static Neo4JSimpleXML.Root root() {
        return root(createClient(), BASE_URI);
    }

    public static Neo4JSimpleXML.Root root(Client client) {
    ...
    public static class Data {
        ...
        public Neo4JSimpleXML.Data.NodeNodeidPropertiesProperty nodeNodeidPropertiesProperty(String nodeid, String property) {
            return new Neo4JSimpleXML.Data.NodeNodeidPropertiesProperty(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), nodeid, property);
        }

        public Neo4JSimpleXML.Data.NodeNodeidProperties nodeNodeidProperties(String nodeid) {
            return new Neo4JSimpleXML.Data.NodeNodeidProperties(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), nodeid);
        }

        public Neo4JSimpleXML.Data.NodeNodeid nodeNodeid(String nodeid) {
            return new Neo4JSimpleXML.Data.NodeNodeid(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), nodeid);
        }

        public Neo4JSimpleXML.Data.NodeNodeidLabels nodeNodeidLabels(String nodeid) {
            return new Neo4JSimpleXML.Data.NodeNodeidLabels(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), nodeid);
        }

        public Neo4JSimpleXML.Data.NodeNodeidRelationshipsAll nodeNodeidRelationshipsAll(String nodeid) {
            return new Neo4JSimpleXML.Data.NodeNodeidRelationshipsAll(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), nodeid);
        }

        public Neo4JSimpleXML.Data.NodeNodeidRelationshipsIn nodeNodeidRelationshipsIn(String nodeid) {
            return new Neo4JSimpleXML.Data.NodeNodeidRelationshipsIn(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), nodeid);
        }

        public Neo4JSimpleXML.Data.NodeNodeidRelationshipsOut nodeNodeidRelationshipsOut(String nodeid) {
            return new Neo4JSimpleXML.Data.NodeNodeidRelationshipsOut(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), nodeid);
        }

        public Neo4JSimpleXML.Data.RelationshipRelationshipid relationshipRelationshipid(String relationshipid) {
            return new Neo4JSimpleXML.Data.RelationshipRelationshipid(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), relationshipid);
        }

        public Neo4JSimpleXML.Data.NodeNodeidReachableNodes nodeNodeidReachableNodes(String nodeid) {
            return new Neo4JSimpleXML.Data.NodeNodeidReachableNodes(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), nodeid);
        }

        public Neo4JSimpleXML.Data.Node node() {
            return new Neo4JSimpleXML.Data.Node(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
        }

        public Neo4JSimpleXML.Data.NodeNodeidRelationships nodeNodeidRelationships(String nodeid) {
            return new Neo4JSimpleXML.Data.NodeNodeidRelationships(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), nodeid);
        }

        public Neo4JSimpleXML.Data.CurrentNodes currentNodes() {
            return new Neo4JSimpleXML.Data.CurrentNodes(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
        }

        public Neo4JSimpleXML.Data.NodeNodeidLabelsLabel nodeNodeidLabelsLabel(String nodeid, String label) {
            return new Neo4JSimpleXML.Data.NodeNodeidLabelsLabel(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), nodeid, label);
        }
        ...
        public static class CurrentNodes {
            ...
            public<T >T getAsTextPlain(GenericType<T> returnType) {
                ...
                if (response.getStatus()>= 400) {
                    throw new Neo4JSimpleXML.WebApplicationExceptionMessage(Response.status(response.getClientResponseStatus()).build());
                }
        ...
        public static class NodeNodeid {
             ...
             * 
             */
            public Neo4JSimpleXML.Data.NodeNodeid setNodeid(String nodeid) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("nodeid", nodeid);
                return new Neo4JSimpleXML.Data.NodeNodeid(_client, copyUriBuilder, copyMap);
            }

            public it.polito.dp2.NFV.sol3.service.data.Node getAsNode() {
                UriBuilder localUriBuilder = _uriBuilder.clone();
                WebResource resource = _client.resource(localUriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                com.sun.jersey.api.client.WebResource.Builder resourceBuilder = resource.getRequestBuilder();
                resourceBuilder = resourceBuilder.accept("application/xml");
                ...
                return response.getEntity(it.polito.dp2.NFV.sol3.service.data.Node.class);
            }
        ...
        public static class NodeNodeidLabels {
             ...
             * 
             */
            public Neo4JSimpleXML.Data.NodeNodeidLabels setNodeid(String nodeid) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("nodeid", nodeid);
                return new Neo4JSimpleXML.Data.NodeNodeidLabels(_client, copyUriBuilder, copyMap);
            }
        ...
        public static class NodeNodeidLabelsLabel {
             ...
             * 
             */
            public Neo4JSimpleXML.Data.NodeNodeidLabelsLabel setNodeid(String nodeid) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("nodeid", nodeid);
                return new Neo4JSimpleXML.Data.NodeNodeidLabelsLabel(_client, copyUriBuilder, copyMap);
            }
             ...
             * 
             */
            public Neo4JSimpleXML.Data.NodeNodeidLabelsLabel setLabel(String label) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
        ...
        public static class NodeNodeidProperties {
             ...
             * 
             */
            public Neo4JSimpleXML.Data.NodeNodeidProperties setNodeid(String nodeid) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("nodeid", nodeid);
                return new Neo4JSimpleXML.Data.NodeNodeidProperties(_client, copyUriBuilder, copyMap);
            }
        ...
        public static class NodeNodeidPropertiesProperty {
             ...
             * 
             */
            public Neo4JSimpleXML.Data.NodeNodeidPropertiesProperty setNodeid(String nodeid) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("nodeid", nodeid);
                return new Neo4JSimpleXML.Data.NodeNodeidPropertiesProperty(_client, copyUriBuilder, copyMap);
            }
             ...
             * 
             */
            public Neo4JSimpleXML.Data.NodeNodeidPropertiesProperty setProperty(String property) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
        ...
        public static class NodeNodeidReachableNodes {
             ...
             * 
             */
            public Neo4JSimpleXML.Data.NodeNodeidReachableNodes setNodeid(String nodeid) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("nodeid", nodeid);
                return new Neo4JSimpleXML.Data.NodeNodeidReachableNodes(_client, copyUriBuilder, copyMap);
            }
        ...
        public static class NodeNodeidRelationships {
             ...
             * 
             */
            public Neo4JSimpleXML.Data.NodeNodeidRelationships setNodeid(String nodeid) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("nodeid", nodeid);
                return new Neo4JSimpleXML.Data.NodeNodeidRelationships(_client, copyUriBuilder, copyMap);
            }
        ...
        public static class NodeNodeidRelationshipsAll {
             ...
             * 
             */
            public Neo4JSimpleXML.Data.NodeNodeidRelationshipsAll setNodeid(String nodeid) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("nodeid", nodeid);
                return new Neo4JSimpleXML.Data.NodeNodeidRelationshipsAll(_client, copyUriBuilder, copyMap);
            }
        ...
        public static class NodeNodeidRelationshipsIn {
             ...
             * 
             */
            public Neo4JSimpleXML.Data.NodeNodeidRelationshipsIn setNodeid(String nodeid) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("nodeid", nodeid);
                return new Neo4JSimpleXML.Data.NodeNodeidRelationshipsIn(_client, copyUriBuilder, copyMap);
            }
        ...
        public static class NodeNodeidRelationshipsOut {
             ...
             * 
             */
            public Neo4JSimpleXML.Data.NodeNodeidRelationshipsOut setNodeid(String nodeid) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("nodeid", nodeid);
                return new Neo4JSimpleXML.Data.NodeNodeidRelationshipsOut(_client, copyUriBuilder, copyMap);
            }
        ...
        public static class RelationshipRelationshipid {
             ...
             * 
             */
            public Neo4JSimpleXML.Data.RelationshipRelationshipid setRelationshipid(String relationshipid) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("relationshipid", relationshipid);
                return new Neo4JSimpleXML.Data.RelationshipRelationshipid(_client, copyUriBuilder, copyMap);
            }
    ...
    public static class Resource {
        ...
        public Neo4JSimpleXML.Resource.NumberOfPUTRequests numberOfPUTRequests() {
            return new Neo4JSimpleXML.Resource.NumberOfPUTRequests(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
        }

        public Neo4JSimpleXML.Resource.NumberOfGETRequests numberOfGETRequests() {
            return new Neo4JSimpleXML.Resource.NumberOfGETRequests(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
        }

        public Neo4JSimpleXML.Resource.NumberOfDELETERequests numberOfDELETERequests() {
            return new Neo4JSimpleXML.Resource.NumberOfDELETERequests(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
        }

        public Neo4JSimpleXML.Resource.NumberOfPOSTRequests numberOfPOSTRequests() {
            return new Neo4JSimpleXML.Resource.NumberOfPOSTRequests(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
        }
    ...
    public static class Root {
        ...
        public Neo4JSimpleXML.Root.SwaggerJson swaggerJson() {
            return new Neo4JSimpleXML.Root.SwaggerJson(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
        }

        public Neo4JSimpleXML.Root.SwaggerYaml swaggerYaml() {
            return new Neo4JSimpleXML.Root.SwaggerYaml(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
        }
