...
public class NfvDeployer {
    ...
    public static NfvDeployer.Nffgs nffgs(Client client, URI baseURI) {
        return new NfvDeployer.Nffgs(client, baseURI);
    }
    ...
    public static NfvDeployer.Nffgs nffgs() {
        return nffgs(createClient(), BASE_URI);
    }

    public static NfvDeployer.Nffgs nffgs(Client client) {
        return nffgs(client, BASE_URI);
    }

    public static NfvDeployer.Catalog catalog(Client client, URI baseURI) {
        return new NfvDeployer.Catalog(client, baseURI);
    }

    public static NfvDeployer.Catalog catalog() {
        return catalog(createClient(), BASE_URI);
    }

    public static NfvDeployer.Catalog catalog(Client client) {
        return catalog(client, BASE_URI);
    }

    public static NfvDeployer.Hosts hosts(Client client, URI baseURI) {
        return new NfvDeployer.Hosts(client, baseURI);
    }

    public static NfvDeployer.Hosts hosts() {
        return hosts(createClient(), BASE_URI);
    }

    public static NfvDeployer.Hosts hosts(Client client) {
    ...
    public static class Catalog {
        ...
        public NfvDeployer.Catalog.VnfName vnfName(String vnfname) {
            return new NfvDeployer.Catalog.VnfName(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), vnfname);
        }
        ...
        public static class VnfName {
             ...
             * 
             */
            public NfvDeployer.Catalog.VnfName setVnfname(String vnfname) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("vnfName", vnfname);
                return new NfvDeployer.Catalog.VnfName(_client, copyUriBuilder, copyMap);
            }
    ...
    public static class Hosts {
        ...
        public NfvDeployer.Hosts.HostName hostName(String hostname) {
            return new NfvDeployer.Hosts.HostName(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), hostname);
        }
        ...
        public static class HostName {
             ...
             * 
             */
            public NfvDeployer.Hosts.HostName setHostname(String hostname) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("hostName", hostname);
                return new NfvDeployer.Hosts.HostName(_client, copyUriBuilder, copyMap);
            }
            ...
            public NfvDeployer.Hosts.HostName.Connections connections() {
                return new NfvDeployer.Hosts.HostName.Connections(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
            }
    ...
    public static class Nffgs {
        ...
        public NfvDeployer.Nffgs.NffgName nffgName(String nffgname) {
            return new NfvDeployer.Nffgs.NffgName(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), nffgname);
        }
        ...
        public static class NffgName {
             ...
             * 
             */
            public NfvDeployer.Nffgs.NffgName setNffgname(String nffgname) {
                Map<String, Object> copyMap;
                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                UriBuilder copyUriBuilder = _uriBuilder.clone();
                copyMap.put("nffgName", nffgname);
                return new NfvDeployer.Nffgs.NffgName(_client, copyUriBuilder, copyMap);
            }
            ...
            public NfvDeployer.Nffgs.NffgName.Nodes nodes() {
                return new NfvDeployer.Nffgs.NffgName.Nodes(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
            }

            public NfvDeployer.Nffgs.NffgName.Links links() {
                return new NfvDeployer.Nffgs.NffgName.Links(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
            }
            ...
            public static class Links {
                ...
                public NfvDeployer.Nffgs.NffgName.Links.LinkName linkName(String linkname) {
                    return new NfvDeployer.Nffgs.NffgName.Links.LinkName(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), linkname);
                }
                ...
                public static class LinkName {
                     ...
                     * 
                     */
                    public NfvDeployer.Nffgs.NffgName.Links.LinkName setLinkname(String linkname) {
                        Map<String, Object> copyMap;
                        copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                        UriBuilder copyUriBuilder = _uriBuilder.clone();
                        copyMap.put("linkName", linkname);
                        return new NfvDeployer.Nffgs.NffgName.Links.LinkName(_client, copyUriBuilder, copyMap);
                    }
            ...
            public static class Nodes {
                ...
                public NfvDeployer.Nffgs.NffgName.Nodes.NodeName nodeName(String nodename) {
                    return new NfvDeployer.Nffgs.NffgName.Nodes.NodeName(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), nodename);
                }
                ...
                public static class NodeName {
                     ...
                     * 
                     */
                    public NfvDeployer.Nffgs.NffgName.Nodes.NodeName setNodename(String nodename) {
                        Map<String, Object> copyMap;
                        copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                        UriBuilder copyUriBuilder = _uriBuilder.clone();
                        copyMap.put("nodeName", nodename);
                        return new NfvDeployer.Nffgs.NffgName.Nodes.NodeName(_client, copyUriBuilder, copyMap);
                    }
                    ...
                    public NfvDeployer.Nffgs.NffgName.Nodes.NodeName.ReachableHosts reachableHosts() {
                        return new NfvDeployer.Nffgs.NffgName.Nodes.NodeName.ReachableHosts(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                    }

                    public NfvDeployer.Nffgs.NffgName.Nodes.NodeName.Links links() {
                        return new NfvDeployer.Nffgs.NffgName.Nodes.NodeName.Links(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues));
                    }
                    ...
                    public static class Links {
                        ...
                        public NfvDeployer.Nffgs.NffgName.Nodes.NodeName.Links.LinkName linkName(String linkname) {
                            return new NfvDeployer.Nffgs.NffgName.Nodes.NodeName.Links.LinkName(_client, _uriBuilder.buildFromMap(_templateAndMatrixParameterValues), linkname);
                        }
                        ...
                        public static class LinkName {
                             ...
                             * 
                             */
                            public NfvDeployer.Nffgs.NffgName.Nodes.NodeName.Links.LinkName setLinkname(String linkname) {
                                Map<String, Object> copyMap;
                                copyMap = new HashMap<String, Object>(_templateAndMatrixParameterValues);
                                UriBuilder copyUriBuilder = _uriBuilder.clone();
                                copyMap.put("linkName", linkname);
                                return new NfvDeployer.Nffgs.NffgName.Nodes.NodeName.Links.LinkName(_client, copyUriBuilder, copyMap);
                            }
